...
public class JpaConfiguration {
	...
	@Value("${datasource.claimManagement.maxPoolSize:10}")
	...
	@Bean
	@Primary
	@ConfigurationProperties(prefix = "datasource.claimManagement")
	...
	private Properties jpaProperties() {
		...
		properties.put("hibernate.dialect", environment.getRequiredProperty("datasource.claimManagement.hibernate.dialect"));
		properties.put("hibernate.hbm2ddl.auto",
				environment.getRequiredProperty("datasource.claimManagement.hibernate.hbm2ddl.method"));
		properties.put("hibernate.show_sql", environment.getRequiredProperty("datasource.claimManagement.hibernate.show_sql"));
		properties.put("hibernate.format_sql", environment.getRequiredProperty("datasource.claimManagement.hibernate.format_sql"));
		properties.put("hibernate.hikari.idleTimeout",
				environment.getRequiredProperty("datasource.claimManagement.hibernate.hikari.idleTimeout"));
		properties.put("hibernate.hikari.maxLifeTime",
				environment.getRequiredProperty("datasource.claimManagement.hibernate.hikari.maxLifeTime"));
		if (StringUtils.isNotEmpty(environment.getRequiredProperty("datasource.claimManagement.defaultSchema"))) {
