...
public class ProviderController {
	...
	public ResponseEntity<?> updateProvider(@PathVariable("id") int id, @RequestBody Provider provider,
		...
		currentProvider.setId(provider.getId());
		...
		currentProvider.setNpi(provider.getNpi());
		currentProvider.setContact(provider.getContact());
		currentProvider.setFacilityAddress(provider.getFacilityAddress());
		currentProvider.setPractice(provider.getPractice());
		currentProvider.setTaxId(provider.getTaxId());
		currentProvider.setTemp(provider.getTemp());
