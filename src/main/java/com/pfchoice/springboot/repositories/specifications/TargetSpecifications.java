...
public class TargetSpecifications implements Specification<Target> {

	private String searchTerm;

	public TargetSpecifications(String searchTerm) {
		super();
		this.searchTerm = searchTerm;
	}

	public Predicate toPredicate(Root<Target> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
