...
public class WeightageSpecifications implements Specification<Weightage> {

	private String searchTerm;

	public WeightageSpecifications(String searchTerm) {
		super();
		this.searchTerm = searchTerm;
	}

	public Predicate toPredicate(Root<Weightage> root, CriteriaQuery<?> cq, CriteriaBuilder cb) {
