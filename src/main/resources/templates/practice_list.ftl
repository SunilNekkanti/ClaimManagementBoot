	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-11">
	                        <label class="col-md-2 control-lable" for="uname">Short Name</label>
	                        <div class="col-md-9">
	                      ...
	                      <div class="form-group col-md-11">
	                       ...
	                       <div class="form-group col-md-11">
	                        <label class="col-md-2 control-lable" for="uname">NPI</label>
	                        <div class="col-md-9">
	                       ...
	                       <div class="form-group col-md-11">
	                        <label class="col-md-2 control-lable" for="uname">Tax ID</label>
	                        <div class="col-md-9">
	                   ...
	                   <div class="row">
	                        <div class="form-group col-md-11">
	                           <label class="col-md-2 control-lable" for="uname">Clearing House URL</label>
	                            <div class="col-md-9">
	                ...
	                <div class="row">
	                    <div class="form-actions floatRight">
	                        ...
	                        <button type="button" ng-click="ctrl.reset()" class="btn btn-warning btn-sm" ng-show="!ctrl.practice.id" ng-disabled="myForm.$pristine">Reset Form</button>
	                        <button type="button" ng-click="ctrl.cancelEdit()" class="btn btn-warning btn-sm" ng-show="ctrl.practice.id" >Cancel</button>
	                        <button type="button" ng-click="ctrl.removePractice(ctrl.practice.id)" class="btn btn-warning btn-sm" ng-show="ctrl.practice.id" >Delete</button>
	                    </div>
	                </div>
	            </form>
    	    </div>
