...
<div class="generic-container" >
   <div class="panel panel-success" ng-if="!ctrl.display">
        ...
        <div class="panel-heading"><span class="priority">List of Priority </span> 
              ...
              <button type="button" ng-click="ctrl.removePriority(ctrl.priorityId)"  ng-show="ctrl.displayEditButton" class="btn btn-danger  custom-width floatRight">Remove</button>  
        </div>
	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-3">
	                            <input type="text" ng-model="ctrl.priority.code" name="code" id="uname" class="username form-control input-sm" placeholder="Enter Priority Code" required ng-minlength="4"/>
	                      ...
	                      <div class="form-group col-md-12">
	                        <label class="col-md-1 col-md-offset-4 control-lable" for="uname">Description</label>
	                        <div class="col-md-3">
	                       <!--  <select class=" form-control" ng-model="ctrl.priority.description" name="description" ng-options="priority.description for priority in ctrl.prioritys | orderBy:'description' track by priority.description" required> -->
	                            <input type="text" ng-model="ctrl.priority.description" name="description" id="uname" class="username form-control input-sm" placeholder="Enter  Description" required ng-minlength="5"/> 
	                             <div class="has-error" ng-show="myForm.$dirty">
	                ...
	                <div class="row">
	                    <div class="form-actions floatRight">
	                        ...
	                        <button type="button" ng-click="ctrl.cancelEdit()" class="btn btn-warning btn-xs">Cancel</button>
 	                        <button type="button" ng-click="ctrl.removePriority(ctrl.priority.id)" class="btn btn-danger btn-xs" ng-show="ctrl.priority.id" >Delete</button>
	                    </div>
	                </div>
	            </form>
    	    </div>
